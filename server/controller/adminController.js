...
export const adminLogin = async (req, res) => {
  ...
  try {
    ...
    console.log("message2", existingAdmin.password, password);
    if (!existingAdmin) {
    ...
    console.log(isPasswordCorrect, "Admin2", req.body);
    ...
    console.log("Admin1", existingAdmin);
...
export const addAdmin = async (req, res) => {
  try {
    const { name, password, dob, department, contactNumber, avatar, email, joiningYear } =
      req.body;
    console.log("Messages1", req.body);
    ...
    console.log("Messages2", req.body);
    let helper;
    if (admins.length < 10) {
    ...
    console.log("Messages3", req.body);
    var username = components.join("");
    let hashedPassword;
    const newDob = dob.split("-").reverse().join("-");

    console.log("Messages4", newDob, req.body);
    ...
    console.log("Messages5", req.body);
  } catch (error) {
    console.log("Messages6", req.body);
    const errors = { backendError: String };
    errors.backendError = error;
    res.status(500).json(errors);
  }
